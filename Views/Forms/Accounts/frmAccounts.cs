...
namespace MizanOriginalSoft.Views.Forms.Accounts
{
    public partial class frmAccounts : Form
    {
        ...
        /*
            جيد جدا .. ولكن فى الجريد اريد منع ظهور حساب تم وضعه فى الشجرة لان له ابناء اريد اظهار فى الجريد فقط الابناء الذين ليس لهم ابناء 
        اى اظهار الحساب النهائى فقط
         */
    }
}